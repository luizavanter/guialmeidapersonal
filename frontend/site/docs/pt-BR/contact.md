...
<p class="lead">
  Pronto para começar sua transformação? Agende uma avaliação gratuita e vamos descobrir qual programa é perfeito para você.
</p>
  ...
  <div class="contact-info">
    ...
    <div class="info-item">
      ...
      <div class="info-content">
        ...
        Atendimento em estúdio parceiro ou residência</p>
      </div>
    </div>
...
<div class="faq-section">
  ...
  <div class="faq-grid">
    <div class="faq-item">
      ...
      <p>Sim! A primeira avaliação não tem nenhum custo. É uma oportunidade para nos conhecermos, você entender minha metodologia e descobrirmos se há compatibilidade para trabalharmos juntos.</p>
    </div>

    <div class="faq-item">
      <h3>Onde são realizados os treinos?</h3>
      <p>Atendo em estúdios parceiros em Jurerê e também faço atendimento em residências (para quem tem equipamentos). A localização específica é definida na avaliação inicial.</p>
    </div>
    ...
    <div class="faq-item">
      ...
      <p>O pagamento é mensal, via PIX ou transferência bancária, sempre no dia 5 de cada mês. Existe desconto de 10% para pagamento trimestral à vista.</p>
    </div>
    ...
    <div class="faq-item">
      ...
      <p>Sim, forneço orientações básicas sobre nutrição esportiva (macronutrientes, timing de refeições). Para planos alimentares detalhados, trabalho em parceria com nutricionistas.</p>
    </div>
...
.faq-item:hover {
  border-color: rgba(196, 245, 58, 0.3);
