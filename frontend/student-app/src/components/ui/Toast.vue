    ...
    <div class="fixed bottom-4 right-4 z-50 flex flex-col gap-2">
      <TransitionGroup name="toast">
        <div
          ...
          class="px-4 py-3 rounded-lg shadow-lg backdrop-blur-sm flex items-center gap-3 min-w-[300px]"
        >
...
const toastClasses = (type: Toast['type']) => {
  const types = {
    ...
    warning: 'bg-yellow-500/90 text-coal',
    info: 'bg-ocean/90 text-white',
  }
  return types[type]
}
</script>
